...
class com.greensock.TimelineLite extends SimpleTimeline {
		/** @private **/
		public static var version:Number = 1.142;
		/** @private **/
		...
		public function gotoAndPlay(timeOrLabel:Object, suppressEvents:Boolean):Void {
			goto(timeOrLabel, Boolean(suppressEvents != false));
			this.play();
		}
		...
		public function goto(timeOrLabel:Object, suppressEvents:Boolean):Void {
			if (typeof(timeOrLabel) == "string") {
				if (_labels[timeOrLabel] != undefined) {
					setTotalTime(Number(_labels[timeOrLabel]), Boolean(suppressEvents != false));
				}
			} else {
				setTotalTime(Number(timeOrLabel), Boolean(suppressEvents != false));
			}
		}
