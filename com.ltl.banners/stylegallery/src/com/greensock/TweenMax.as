...
class com.greensock.TweenMax extends TweenLite {
		/** @private **/
		public static var version:Number = 11.14;
		 ...
		 * 
		 * @param vars Object containing properties with the end values that should be udpated. You do <b>NOT</b> need to redefine all of the original <code>vars</code> values - only the ones that should be updated. For example, to update the destination <code>_x</code> value to 300 and the destination <code>_y</code> value to 500, pass: <code>{_x:300, _y:500}</code>.
