package top_level
{
	...
	public function __add_linked_list_behaviour_array(target_array : Array) : Array 
	{
		...
		var first_node : IDouble_Linked_List_Node = IDouble_Linked_List_Node(target_array[0]);
		var last_node : IDouble_Linked_List_Node = IDouble_Linked_List_Node(target_array[target_array.length - 1]);
