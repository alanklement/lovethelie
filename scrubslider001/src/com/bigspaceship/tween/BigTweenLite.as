...
package com.bigspaceship.tween {
	...
	public class BigTweenLite extends EventDispatcher{
		...
		public function BigTweenLite($target:Object, $duration:Number, $vars:Object) {
		...
		public static function to($target:Object, $duration:Number, $vars:Object):BigTweenLite {
			return new BigTweenLite($target, $duration, $vars);
		}
		...
		public static function from($target:Object, $duration:Number, $vars:Object):BigTweenLite {
			$vars.runBackwards = true;
			return new BigTweenLite($target, $duration, $vars);
		}
		
		public static function delayedCall($delay:Number, $onComplete:Function, $onCompleteParams:Array = null, $onCompleteScope:* = null):BigTweenLite {
			return new BigTweenLite($onComplete, 0, {delay:$delay, onComplete:$onComplete, onCompleteParams:$onCompleteParams, onCompleteScope:$onCompleteScope, overwrite:false}); //NOTE / TO-DO: There may be a bug in the Dictionary class that causes it not to handle references to objects correctly! (I haven't verified this yet)
		}
		...
		public function complete($skipRender:Boolean = false):void {
			...
			// BSS EDIT ======================================================================================================
			dispatchEvent(new BigTweenLiteEvent(BigTweenLiteEvent.COMPLETE, this.vars.onCompleteParams));
			// end BSS EDIT ==================================================================================================
			
			removeTween(this);
		}
		
		public static function removeTween($t:BigTweenLite = null):void {
...
//---- GETTERS / SETTERS -----------------------------------------------------------------------
		...
		public function get active():Boolean {
			if (_active) {
				...
				// BSS EDIT ======================================================================================================
				dispatchEvent(new BigTweenLiteEvent(BigTweenLiteEvent.START, this.vars.onStartParams));
				// end BSS EDIT ==================================================================================================
